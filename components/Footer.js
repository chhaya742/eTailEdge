            ...
            <footer className="text-gray-600 body-font ">
                <div className="container px-5 md:py-24 py-18 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        <Link href={"/"}><img className='m-auto h-12 w-30' src="/logo.png" alt="eTailEdge" /></Link>
                        <p className="mt-2 text-sm text-gray-500 px-6">eTailEdge -Wear The &lt;code&gt; premium coding tshirts and hoodies and apperalas</p>
                    </div>
                ...
                <div className="bg-gray-100">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-gray-500 text-sm text-center sm:text-left">© 2020 eTailEdge — Al Rights Reserved
