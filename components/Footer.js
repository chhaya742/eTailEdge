      ...
      <div className="container px-5 py-16 mx-auto flex md:items-start md:flex-row flex-col">
        ...
        <div className="w-64 mx-auto md:mx-0 text-center md:text-left">
          ...
          <p className="mt-3 text-sm text-gray-500">
            eTailEdge — Wear premium coding t-shirts, hoodies, mugs and stickers
        ...
        <div className="flex-grow flex flex-wrap md:pl-20 mt-10 md:mt-0 text-center md:text-left">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none space-y-2">
              <li>
                <Link href="/category/tshirts" className="hover:text-black">
                  T-Shirts
                </Link>
              </li>
              <li>
                <Link href="/category/hoodies" className="hover:text-black">
                  Hoodies
                </Link>
              </li>
              <li>
                <Link href="/category/mugs" className="hover:text-black">
                  Mugs
                </Link>
              </li>
              <li>
                <Link href="/category/stickers" className="hover:text-black">
                  Stickers
                </Link>
              </li>
            </nav>
