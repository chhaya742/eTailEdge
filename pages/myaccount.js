...
const MyAccount = ({ cart, clearCart, addToCart, removeCart, subtl }) => {
    ...
    const [password,setpassword]=useState({PreviousPassword:"",NewPassword:""})
  ...
  return (
    ...
    <h1 className='font- text-xl my-8 text-center'>MyAccount</h1>
    ...
    <div>
    <h2 className='font-semi text-xl'>2.Change Password</h2>
    <div className="mx-auto flex my-1 md:my-4">
      <div className="px-2 w-1/2">
        <div className=" mb-4">
          <label htmlFor="PreviousPassword" className="leading-7 text-sm text-gray-600">Previous Password</label>
          <input value={password.NewPassword} type="password" id="PreviousPassword" name="PreviousPassword"  className="w-full bg-white rounded border border-gray-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
          {error.name && <div style={{ color: "red" }}>{error.name}</div>}
        </div>
      </div>
      <div className="px-2 w-1/2">
        <div className=" mb-4">
          ...
          <input value={password.PreviousPassword} type="password" id="NewPassword" name="NewPassword"  className="w-full bg-white rounded border border-gray-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out "/>
          {error.email && <div style={{ color: "red" }}>{error.email}</div>}
        </div>

      </div>
    </div>
    <button className='bg-pink-600 px-1 py-1 rounded-md text-xl md:text-xl cursor-pointer mr-7'>update</button>
